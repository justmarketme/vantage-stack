...
import { analyzeFunnel } from "../../../../lib/analytics/engine-v2";
...
async function handler(req: Request) {
  ...
  try {
    ...
    const out = await analyzeFunnel(db, { start_date, end_date });
...
export const GET = withApiMonitoring({ route: "/api/analytics/funnel", method: "GET", handler });
